...
file.census.count <- file.path(indir.repository, 'data', 'RCCS_census_eligible_individuals_221209.csv')
...
file <- file.path(indir.repository, 'data', 'RCCS_participation_221209.csv')
