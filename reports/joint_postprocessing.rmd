...
type2text <- function(x){
    ...
    dict <- c(
        'barenumviraemiccensel' = "Expected number of viraemic among Census Eligible",
...
```{r show-plots, echo=FALSE, hidden=TRUE, message=FALSE, results='asis', fig.height=12, fig.width=16}
{
    dplots[, {
